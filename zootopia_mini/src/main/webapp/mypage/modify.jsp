...
<div class="container">
        ...
        <form method="post" class="update-form"  action="zootopia.do?command=mypage/modify" name="modifyForm">
            ...
            <div class="form-group">
                ...
                <input type="text" id="pet-name" class="form-control" value="">
            </div>
            <div class="form-group">
        ...
        <p class="login-link">이미 계정이 있으신가요? <a href="member/loginForm.jsp">로그인</a></p>
    </div>
