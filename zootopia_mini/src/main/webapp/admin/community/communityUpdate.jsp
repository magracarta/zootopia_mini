...
<section>
	...
	<article>
		<form name="updateForm" action="zootopia.do?command=admincommunityupdate" method="post" 
			...
			<div class="btn">
				...
				<input type="button" value="취소" onClick="location.href='zootopia.do?command=admincommunitydetail&gseq=${communityVO.gseq}'">
			</div>
		</form>
	</article>
