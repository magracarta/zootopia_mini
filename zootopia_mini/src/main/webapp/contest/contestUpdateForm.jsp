		...
		<form name="contestform">
			...
			<div class="paricipant selectcontainer">
				...
				<div class="select-container">
					<ul>
						<li data-value="none"><a href="javascript:">변경하지 않기</a></li>
						<c:forEach begin ="${contest_detail.cpdList.size()}" end ="6" varStatus="status">
...
<script>
	document.querySelectorAll('.lastdate li').forEach((elem,index)=>{
	    console.log(elem.dataset.value);
	    if(elem.dataset.value == ${contest_detail.content} ) elem.click();
	});
